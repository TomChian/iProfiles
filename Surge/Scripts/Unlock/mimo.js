/*
http-response ^https:\/\/api\.revenuecat\.com\/.*\/(receipts$|subscribers) requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/langkhach270389/Scripting/master/mojo.vip.js,script-update-interval=0
